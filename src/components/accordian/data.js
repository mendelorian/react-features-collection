const data = [
  ...
  {
    id: '4',
    question: "Can I create an accordian component with different framework?",
    answer: "Yes, it is very possible to create an accordian component with another framework."
  }
];
